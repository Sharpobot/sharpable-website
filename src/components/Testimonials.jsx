...
export default function Testimonials() {
  ...
  useEffect(() => {
    const updateWidth = () => {
      setCardWidth(window.innerWidth < 640 ? window.innerWidth - 48 : 420)
    }
    updateWidth()
  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto px-6 sm:px-10 lg:px-16">
        <div
          className={`flex items-end justify-between gap-6 mb-12 sm:mb-16 transition-all duration-1000 ease-out ${
        ...
        >
          ...
          <div className="hidden sm:flex items-center gap-2 shrink-0 pb-2">
            ...
            <span className="font-mono text-xs text-muted">{t.testimonials.rating}</span>
          </div>
        </div>
      </div>
      ...
      >
        <div className="overflow-x-hidden pl-6 sm:pl-10 lg:pl-16 py-4 -my-4">
          <div
            ref={trackRef}
            className="flex"
            style={{
            ...
            {items.map((item, i) => {
              ...
              return (
                ...
                >
                  ...
                  <p className="text-ink text-base leading-relaxed mt-5 mb-7">{item.quote}</p>
        ...
        <div className="flex items-center gap-3 mt-8 px-6 sm:px-10 lg:px-16 max-w-7xl mx-auto justify-end">
          <button
            type="button"
            onClick={goPrev}

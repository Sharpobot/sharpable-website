  ...
  return (
    ...
    >
      ...
      <svg className="absolute left-3 right-3 top-9 h-5" viewBox="0 0 400 20" preserveAspectRatio="none">
        <rect x="0" y="2" width="400" height="16" rx="1" fill="#FFC629" fillOpacity="0.12" />
        <rect x="0" y="2" width="400" height="16" rx="1" fill="none" stroke="#FFC629" strokeOpacity="0.25" strokeWidth="1" />
        ...
        <rect x="48" y="6.5" width="180" height="7" rx="0.75" fill="#FFC629" fillOpacity="0.18" />
      </svg>
